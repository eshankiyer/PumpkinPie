...
pub struct Enchantment {
    ...
    #[doc = r#" Vanilla `EnchantmentDefinition.primaryItems`; `None` means "same as"#]
    #[doc = r#" `supported_items`" (`Enchantment.java:130-131`)."#]
...
impl Enchantment {
    ...
    #[doc = r" Mirrors `Enchantment.isPrimaryItem` (`Enchantment.java:130-131`): supported, and"]
    #[doc = r" either the enchantment declares no `primary_items` set or the item is in it."]
    #[doc = r""]
    #[doc = r" This, not `can_enchant`, is what an enchanting table rolls against"]
    #[doc = r" (`EnchantmentHelper.getAvailableEnchantmentResults`, `EnchantmentHelper.java:597-601`)."]
