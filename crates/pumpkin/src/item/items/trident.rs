    ...
    fn normal_use<'a>(
        ...
        Box::pin(async move {
            let riptide_level = {
                ...
                stack.get_enchantment_level(&pumpkin_data::Enchantment::RIPTIDE) as u32
            };
            if riptide_level > 0 && !player.is_in_water_or_rain().await {
                return;
            }
    ...
    fn on_stopped_using<'a>(
        ...
        Box::pin(async move {
            ...
            if riptide_level > 0 {
                ...
                player
                    .living_entity
                    .start_auto_spin_attack(20, 8.0, stack_guard.clone())
                    .await;
                if player
                    .get_entity()
                    .on_ground
                ...
                if player.gamemode.load() != GameMode::Creative {
                    player
                        .damage_item_stack_without_breaking(&stack_guard)
                        .await;
                }
                return;
            }
