...
/// A hopper minecart's container is the same five slots a hopper block entity has
/// (`AbstractMinecartContainer.getContainerSize` -> `MinecartHopper` = 5), and every
/// one of them is a valid insertion target regardless of facing.
const HOPPER_MINECART_SLOTS: [usize; 5] = [0, 1, 2, 3, 4];
