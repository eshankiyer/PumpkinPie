...
impl AxolotlEntity {
    ...
    fn apply_supporting_effects(player: &Player) {
        ...
        let existing = living.get_effect(&StatusEffect::REGENERATION);
        ...
        living.remove_effect(&StatusEffect::MINING_FATIGUE);
    }
...
impl Mob for AxolotlEntity {
    ...
    fn on_successful_attack(&self, target: &dyn EntityBase) {
        ...
        Self::apply_supporting_effects(player);
    }
}
