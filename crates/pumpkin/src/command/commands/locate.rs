...
impl CommandExecutor for LocateBiomeExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        let searched =
            ResourceOrTagArgument::get_resource_or_tag(context, ARG_BIOME, BIOME_REGISTRY)?.clone();
...
impl CommandExecutor for LocatePoiExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        let searched = ResourceOrTagArgument::get_resource_or_tag(context, ARG_POI, &POI_REGISTRY)?;
