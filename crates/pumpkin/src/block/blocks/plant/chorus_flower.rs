...
impl BlockBehaviour for ChorusFlowerBlock {
    ...
    fn random_tick(&self, args: RandomTickArgs<'_>) {
        ...
        {
            place_stem(world, &pos);
            place_grown_flower(world, &above, age);
            ...
            for _ in 0..attempts {
                ...
                {
                    place_grown_flower(world, &target, age + 1);
                    created_branch = true;
                }
            }
...
fn place_stem(world: &Arc<World>, pos: &BlockPos) {
    let state =
...
fn place_grown_flower(world: &Arc<World>, pos: &BlockPos, age: u8) {
...
fn place_dead_flower(world: &Arc<World>, pos: &BlockPos) {
