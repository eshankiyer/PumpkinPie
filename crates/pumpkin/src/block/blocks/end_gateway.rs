...
use crate::block::{BlockBehaviour, OnEntityCollisionArgs, PlacedArgs};
...
impl BlockBehaviour for EndGatewayBlock {
    ...
    fn on_entity_collision(&self, args: OnEntityCollisionArgs<'_>) {
        ...
        if !entity.is_alive() || entity.has_vehicle() {
            return;
        }
        ...
        entity_arc.teleport(destination, None, None, args.world.clone());
    }
}
