...
/// Extension trait for `DyeColor`, which lives in `pumpkin-data` and so cannot carry an
/// inherent `impl` here.
pub trait DyeColorExt: Sized {
    ...
    fn mixed_color(a: Self, b: Self, rng: &mut impl rand::RngExt) -> Self;
}

impl DyeColorExt for DyeColor {
    fn mixed_color(a: Self, b: Self, rng: &mut impl rand::RngExt) -> Self {
