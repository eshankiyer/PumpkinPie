...
pub struct LootContextParameters {
    ...
    /// Block entity captured before removal for block loot functions such as
        ...
        match &self.content {
            ...
            LootFunctionTypes::CopyComponents { source, include } => {
                ...
                if *source == "block_entity"
                    && include.contains(&"minecraft:pot_decorations")
                    && let Some(block_entity) = params.block_entity.as_ref()
                    ...
                    && let Some(decorations) = pot.decorations()
                {
                    for stack in stacks {
                        stack.patch.push((
                            ...
                            Some(
                                Box::new(pumpkin_data::data_component_impl::PotDecorationsImpl {
