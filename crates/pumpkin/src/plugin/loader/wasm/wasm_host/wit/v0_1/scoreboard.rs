...
impl scoreboard::HostScoreboard for PluginHostState {
    ...
    async fn add_objective(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().add_objective(objective);
            }
            ScoreboardProvider::Player(player) => {
                let mut custom_guard = player.custom_scoreboard.lock();
                if !matches!(
                    *custom_guard,
    ...
    async fn set_display_slot(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().set_display_objective(
                    world.as_ref(),
                    slot,
                    Some(&objective_name),
                );
    ...
    async fn update_score(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().update_score(world.as_ref(), score);
            }
            ScoreboardProvider::Player(player) => {
                let mut custom_guard = player.custom_scoreboard.lock();
                if !matches!(
    ...
    async fn add_score(
        ...
        let new_val = match provider {
            ScoreboardProvider::World(world) => world.scoreboard.lock().add_score(
                world.as_ref(),
                entity_name,
                objective_name,
                delta,
    ...
    async fn create_team(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().add_team(world.as_ref(), team);
            }
            ScoreboardProvider::Player(player) => {
                let mut custom_guard = player.custom_scoreboard.lock();
                if !matches!(
    ...
    async fn remove_team(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().remove_team(world.as_ref(), &name);
            }
            ScoreboardProvider::Player(player) => {
                let mut custom_guard = player.custom_scoreboard.lock();
                if let Some(crate::entity::player::CustomScoreboard::Java(sb)) =
    ...
    async fn update_team(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().update_team(world.as_ref(), team);
            }
            ScoreboardProvider::Player(player) => {
                let mut custom_guard = player.custom_scoreboard.lock();
                if let Some(crate::entity::player::CustomScoreboard::Java(sb)) =
    ...
    async fn remove_player_from_team(
        ...
        match provider {
            ScoreboardProvider::World(world) => {
                world.scoreboard.lock().remove_player_from_team(
                    world.as_ref(),
                    &team_name,
                    &player_name,
                );
    ...
    async fn get_teams(
        ...
        let teams = match provider {
            ScoreboardProvider::World(world) => world
                ...
                .collect(),
            ScoreboardProvider::Player(player) => {
                let custom_guard = player.custom_scoreboard.lock();
                if let Some(crate::entity::player::CustomScoreboard::Java(sb)) =
                    custom_guard.as_ref()
                {
    ...
    async fn get_team(
        ...
        let team_opt = match provider {
            ScoreboardProvider::World(world) => world.scoreboard.lock().get_team(&name).cloned(),
            ScoreboardProvider::Player(player) => {
                let custom_guard = player.custom_scoreboard.lock();
                if let Some(crate::entity::player::CustomScoreboard::Java(sb)) =
                    custom_guard.as_ref()
