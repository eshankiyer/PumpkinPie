...
#[cfg(test)]
mod tests {
    use super::{MetadataValue, SyncedActorDataList, entity_data_flag, entity_data_key};
    ...
    fn setting_a_flag_preserves_seeded_bits() {
        ...
        let mut meta = SyncedActorDataList::new();
        meta.set(entity_data_key::FLAGS, MetadataValue::Int64(base));
        meta.set_flag(
        ...
        let Some(MetadataValue::Int64(flags)) = meta.0.get(&entity_data_key::FLAGS) else {
